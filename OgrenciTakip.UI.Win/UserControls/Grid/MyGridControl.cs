...
namespace OgrenciTakip.UI.Win.UserControls.Grid
{
    ...
    public class MyGridView : GridView, IStatusBarKisayol
    {
        ...
        public MyGridView() { } //formun design sayfasında bu yaptığımız custom gridview'den hata vermeden instance oluşturması için
        ...
        protected override void OnColumnChangedCore(GridColumn column)
        {
            ...
            else if (column.ColumnEdit.GetType() == typeof(RepositoryItemDateEdit))
            {
